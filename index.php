...
<html lang="en">
	<head>
		...
		<link href="https://fonts.googleapis.com/css?family=Raleway|Roboto+Slab|Merriweather" rel="stylesheet">
	...
	<body>
		<header>
			<nav class="navbar navbar-expand-lg navbar-dark bg-info">
				<div id="mainMenu" class="mx-auto">
				  <a class="navbar-brand" href="#">Quitting Weed: The Complete Guide</a>
		...
		<main>
			...
			<section id="features" class="features">
				<div class="text-center">
					<h2 class="pt-4 mb-0">Book Features</h2>
					<h6 class="text-muted">what you will learn</h6>
					<hr class="feat-rule">
				...
				<div class="review">
					<div class="review-cont">
						<div class="quote">
							...
							<cite>
								<p>This book from the first few pages made me feel I wasn't alone.</p>
								<p class="mb-0">Highly recommended by someone who thought they'd never escape the tyranny of the weed.</p>
							</cite>
							<img src="icons/quote-end.png">
							<p class="reviewer">Kathleen B.</p>
						</div>
					</div>
				</div>
				...
				<div class="review">
					<div class="review-cont">
						<div class="quote">
							<img src="icons/quote-open.png">
							<cite>
								<p>I do not smoke weed and never have but I was very concerned about my sons one of which is suffering badly from smoking it although he is still in denial. So I decided to read up on what it is like to quit and how to quit. Matthew's book has really boosted my confidence about what is involved and how to go about it to the point where I feel what I have learned and how I talk to my sons about the subject has got them questioning their own use and cutting down. </p>
								<p class="mb-0">The book is very readable, not too long and drawn out but clear concise and informative. Perfectly structured and enlightening too. I now feel equipped to handle what my sons are doing and on helping them exit when that comes....and it will.</p>
							</cite>
							<img src="icons/quote-end.png">
							<p class="reviewer">Giles R.</p>
						</div>
					</div>
				</div>
				...
				<div class="review">
					<div class="review-cont">
						<div class="quote">
							<img src="icons/quote-open.png">
							<cite>
								<p>This book covers everything. Unfortunately this area of addiction is often overlooked or downplayed. I learned some things I didn't know.</p>
								<p>There's no judgment here, just a straightforward guide to understanding what is happening with your body and brain on this drug. If you don't have a problem with weed, or it is even beneficial to you that is totally cool, but that is not the case for some.</p>
								<p class="mb-0">Sadly for myself and others it has become a toxic influence. There is no shame in becoming addicted to an addictive substance, if this happens to resonate with you ( I mean you are looking into a book specifically about quitting weed and reading reviews for it 😅) I definitely recommend it, as it will walk you through the process of understanding why this stuff is causing problems for you, what to expect when you quit, and how to recognize, and even hopefully prevent an oncoming relapse.</p>
							</cite>
							<img src="icons/quote-end.png">
							<p class="reviewer">Mimi</p>
						</div>
					</div>
				</div>
				...
				<div class="review">
					<div class="review-cont">
						<div class="quote">
							<img src="icons/quote-open.png">
							<cite>
								<p class="mb-0">An excellent, well-organized, and clearly written manual for quitting marijuana addiction. If you or a loved one has this problem, this book is an excellent place to start.</p>
							</cite>
							<img src="icons/quote-end.png">
							<p class="reviewer">Glenn V.</p>
						</div>
					</div>
				</div>
				...
				<div class="review">
					<div class="review-cont">
						<div class="quote">
							<img src="icons/quote-open.png">
							<cite>
								<p class="mb-0">I am a child and adolescent psychologist and this book is the best resource I have found to address marajuana addiction. I see so many unhappy, underachieving youth who are trapped in a terrible cyle with this substance. The author clearly explains the problems chronic users face while weaving in research and resources. He also provides a lot of encouagement for those toying with quitting. I will recommend this book to any family I meet who is dealing with this challenge.</p>
							</cite>
							<img src="icons/quote-end.png">
							<p class="reviewer">Katherine Q.</p>
						</div>
					</div>
				</div>
				...
				<div class="review mb-4">
					<div class="review-cont">
						<div class="quote">
							<img src="icons/quote-open.png">
							<cite>
								<p class="mb-0">This book is right on point. Clearly the author knows what he’s talking about. Good for anyone at any point of their journey. Learned even more reasons why I needed to do this. Easy to read.</p>
							</cite>
							<img src="icons/quote-end.png">
							<p class="reviewer">SM</p>
						</div>
					</div>
				</div>
					...
					<div class="chapters-group">
						...
						<div class="card">
						  ...
						  <div class="card-body">
						    ...
						    <p class="card-text text-muted">Hear from others who have successfully quit or are currently in the process</p>
						  </div>
						</div>
					</div>
				</div>
						...
						<ul id="previews">
							<li>
								...
								<div id="chap1Preview" class="text-muted text-justify mt-2 mb-2 merriweather">
									...
									<h6 class="text-center font-weight-bold">The Sedated Life<h6>

									<p>You wake up, your head feels groggy. You have little energy. After forcing yourself to get up, within an hour, you have a smoke.</p>

									<p>You slowly go about your day. Maybe you work, maybe you don’t. Conversation is difficult; you are unable to look people in the eye, unable to even string a coherent sentence together. You feel ashamed that you have little-to-no social skills. You never laugh or smile anymore; you seem to be in a permanent state of numbness. All you are concerned about is looking towards the next high, even though each subsequent high of the day is less and less effective at making you feel ok.</p>

									<p>Evening rolls around, and once again you find yourself in front the TV or computer, numbing and distracting yourself further. You gorge yourself on take-away food and unhealthy snacks. Any tasks or jobs you had planned have been left for another day.</p>

									<p>This terrible cycle continues day in, day out. You alternate between momentarily feeling good, before returning to that familiar state: lethargic, fuzzy, empty, numb, and above all, unhappy with life. Each day, you find that a little part of you dies; each day, you get slightly further away from your real self.</p>

									<p>Sometimes, you wonder if there is another life out there, away from the weed, away from the lonely, monotonous existence that your life has become. For a brief moment, you stop pretending that life is all good, and you begin to gaze upon the reality you have been blinding yourself to: you have neglected your life.</p>

									<p>You have traded in real growth and development in favour of a meaningless, artificial euphoria, kidding yourself that all is fine, when the reality is anything but. As the discomfort of this truth starts to set in, your brain persuades you why you should continue to smoke: it helps open your mind, it’s a social activity, it helps you be creative, it helps take the edge off the futility of life, it’s harmless, everyone does it, it’s not heroin, and so on, and so on.</p>
							...
							<li>
								...
								<div id="chap3Preview" class="text-muted text-justify mt-2 mb-2 merriweather">
									...
									<p>The frying of your reward circuitry – the reduction in sensitivity to dopamine – manifests itself in a variety of negative ways. Here is a list of potential symptoms of low levels of dopamine, many of which will sound familiar:</p>

									<ul>
										<li>Fatigue</li>
										<li>Anhedonia (inability to feel pleasure)</li>
										<li>Lack of motivation and drive</li>
										<li>Insomnia</li>
							...
							<li>
								...
								<div id="chap4Preview" class="text-muted text-justify mt-2 mb-2 merriweather">
									...
									<p>Why are we so drawn to weed in the first place? </p>

									<p>Why are some people addicted to cannabis, whilst others have no trouble moderating their use?</p>

									<p>Why do we continue to smoke even when we want to stop?</p>

									<p>Having looked at the physiology of cannabis addiction on the body and brain, it is time to explore the deeper psychological motivations at play. Knowing why you are addicted will help to increase your self-awareness, which will improve your chances of success.</p>
